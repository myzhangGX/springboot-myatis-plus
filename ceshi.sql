...
CREATE TABLE `goods`  (
  ...
  `name_desc` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  ...
  `image_url` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `start_time` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
...
INSERT INTO `m_blog` VALUES (15, 1, 'zhang', 'zhang', 'zhang\n\n```\nasfklmsdaklfmls\n\n```\nzhang\n\n```\nnklsdnflk\n\n```\n', '2021-06-02 08:57:33', 0);
...
-- Records of m_user
-- ----------------------------
INSERT INTO `m_user` VALUES (1, 'zhang', 'http://localhost:8080/user/kslls', '1972724673@qq.com', '202cb962ac59075b964b07152d234b70', 1, '2021-05-15 15:12:20', NULL);
...
CREATE TABLE `user`  (
  ...
  `character` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '角色',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'zhang', '123', '员工');

-- ----------------------------
-- Table structure for userk
-- ----------------------------
...
-- ----------------------------
-- Table structure for yuanggong
-- ----------------------------
DROP TABLE IF EXISTS `yuanggong`;
CREATE TABLE `yuanggong`  (
  `staffid` int NOT NULL AUTO_INCREMENT,
  `staffname` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `sex` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `namsd` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `dianhuan` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `dizhi` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`staffid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yuanggong
-- ----------------------------
INSERT INTO `yuanggong` VALUES (4, '张凯', '男', '21', '747557612@qq.com', '重庆');
INSERT INTO `yuanggong` VALUES (5, '往届生', '男', '24', '747557612@qq.com', '重庆');
INSERT INTO `yuanggong` VALUES (6, '肖子翔', '男', '22', '1223545', '重庆');
INSERT INTO `yuanggong` VALUES (7, '姚添', '男', '21', '1008611', '重庆');
INSERT INTO `yuanggong` VALUES (8, '张东', '男', '21', '10010', '重庆');
INSERT INTO `yuanggong` VALUES (10, '黄灿', '男', '21', '110', '广州');
